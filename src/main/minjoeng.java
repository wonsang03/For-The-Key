...
//    public KeyHandler keyH = new KeyHandler(this);  // 민정 수정 (Tab 키 구현 때문)
//    
//    // [민정 추가] 바닥에 떨어진 무기들을 저장하는 리스트
...
//        }
//        
//        // [민정 추가] 바닥에 떨어진 무기 그리기 (반드시 플레이어보다 먼저 혹은 비슷하게)
//        for (int i = 0; i < groundWeapons.size(); i++) {
//            if (groundWeapons.get(i) != null) {
//                groundWeapons.get(i).draw(g2, this);
//            }
//        }
//
//        // [서충만님 코드] 맵 그리기
