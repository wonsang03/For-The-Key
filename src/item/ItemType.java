...
public enum ItemType {
    POWER_FRUIT("Power Fruit", "공격력 +20%", 0.2, 0, 0, 0, Rarity.NORMAL),
    LIFE_SEED("Life Seed", "최대 체력 +5", 0, 10, 0, 0, Rarity.NORMAL),
    WIND_CANDY("Wind Candy", "이동속도 +10%", 0, 0, 0.5, 0, Rarity.NORMAL),
    ...
    VAMPIRE_TOOTH("Vampire Tooth", "적 처치 시 체력 +10 회복", 0, 0, 0, 0, Rarity.RARE),
    DRAGON_SCALE("Dragon Scale", "최대 체력 +100", 0, 200, 0, 0, Rarity.LEGENDARY),
    RED_POTION("Red Potion", "체력 +30 회복", 0, 100, 0, 0, Rarity.NORMAL),
    ELIXIR("Elixir", "체력 완전 회복", 0, 9999, 0, 0, Rarity.LEGENDARY),
	GHOST_CLOAK("Ghost Cloak", "5초간 무적", 0, 0, 0, 0, Rarity.LEGENDARY);
